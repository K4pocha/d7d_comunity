    ...
    <div className="min-h-screen bg-[#050505] pt-36 pb-12 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          ...
          {/* Tarjeta Torneos (ACTIVADA) */}
          <Link href="/admin/torneos" className="group bg-[#0a0a0a] border border-white/10 p-6 rounded-xl hover:border-sk-accent/50 transition-all hover:-translate-y-1">
            <div className="flex justify-between items-start mb-4">
              <div className="p-3 bg-purple-500/10 rounded-lg text-purple-400"><Trophy size={24} /></div>
              <ArrowIcon />
            </div>
            <h3 className="text-xl font-bold text-white mb-1 group-hover:text-sk-accent">Gestionar Torneos</h3>
            <p className="text-sm text-gray-500">Crear brackets y actualizar resultados.</p>
          </Link>
