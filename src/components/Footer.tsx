...
// Componente del icono de Discord (mantenlo igual)
...
export default function Footer() {
  ...
  // 2. CREAMOS LA LISTA RELACIONANDO ICONOS CON EL JSON
  const socialNetworks = [
    ...
    // Si quieres Facebook, descomenta esto:
    // { icon: Facebook, href: socialLinks.facebook, label: "Facebook" },
  ];

  // Filtramos para mostrar solo los que tengan link (no estén vacíos)
  ...
  return (
    <footer className="bg-[#050505] border-t border-white/10 pt-20 pb-10 mt-auto">
      <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-row justify-between items-center gap-10">
        ...
        {/* TEXTO */}
        <div>
          <h2 className="text-5xl md:text-8xl font-black tracking-tighter text-transparent bg-clip-text bg-gradient-to-b from-white to-gray-800 opacity-90">
            SIGUENOS
          </h2>
          <p className="text-gray-500 mt-2 uppercase tracking-widest text-sm">Se parte de #DIsp7aceDNetwork</p>
        </div>
